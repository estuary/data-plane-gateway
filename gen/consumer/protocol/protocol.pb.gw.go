...
import (
	"context"
	ext "go.gazette.dev/core/consumer/protocol"
	"io"
	"net/http"
...
func request_Shard_Stat_0(ctx context.Context, marshaler runtime.Marshaler, client ext.ShardClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ext.StatRequest
...
func local_request_Shard_Stat_0(ctx context.Context, marshaler runtime.Marshaler, server ext.ShardServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ext.StatRequest
	var metadata runtime.ServerMetadata
...
func request_Shard_List_0(ctx context.Context, marshaler runtime.Marshaler, client ext.ShardClient, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
...
func local_request_Shard_List_0(ctx context.Context, marshaler runtime.Marshaler, server ext.ShardServer, req *http.Request, pathParams map[string]string) (proto.Message, runtime.ServerMetadata, error) {
	var protoReq ext.ListRequest
	var metadata runtime.ServerMetadata
...
// ext.RegisterShardHandlerServer registers the http handlers for service Shard to "mux".
// UnaryRPC     :call ext.ShardServer directly.
...
func RegisterShardHandlerServer(ctx context.Context, mux *runtime.ServeMux, server ext.ShardServer) error {
...
func RegisterShardHandler(ctx context.Context, mux *runtime.ServeMux, conn *grpc.ClientConn) error {
	return RegisterShardHandlerClient(ctx, mux, ext.NewShardClient(conn))
}

// ext.RegisterShardHandlerClient registers the http handlers for service Shard
...
func RegisterShardHandlerClient(ctx context.Context, mux *runtime.ServeMux, client ext.ShardClient) error {
