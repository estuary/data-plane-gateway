...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    v1: {
         ...
         */
        journalList: (body: ProtocolListRequest, params?: RequestParams) => Promise<HttpResponse<ProtocolListResponse, RuntimeError>>;
        /**
         * No description
         *
         * @tags Journal
         ...
         * @response `default` `RuntimeError` An unexpected error response.
         */
        journalRead: (body: ProtocolReadRequest, params?: RequestParams) => Promise<HttpResponse<{
            result?: ProtocolReadResponse | undefined;
            error?: RuntimeStreamError | undefined;
        }, RuntimeError>>;
    };
}
export {};
