...
export declare class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
    v1: {
         ...
         * @request POST:/v1/shards/list
         * @response `200` `ConsumerListResponse` A successful response.
         * @response `default` `RuntimeError` An unexpected error response.
         */
        shardList: (body: ConsumerListRequest, params?: RequestParams) => Promise<HttpResponse<ConsumerListResponse, RuntimeError>>;
        /**
         * No description
         *
         * @tags Shard
         ...
         * @request POST:/v1/shards/stat
         * @response `200` `ConsumerStatResponse` A successful response.
         * @response `default` `RuntimeError` An unexpected error response.
         */
        shardStat: (body: ConsumerStatRequest, params?: RequestParams) => Promise<HttpResponse<ConsumerStatResponse, RuntimeError>>;
    };
}
export {};
