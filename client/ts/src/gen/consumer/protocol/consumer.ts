...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  v1 = {
     ...
     */
    shardList: (body: ConsumerListRequest, params: RequestParams = {}) =>
      this.request<ConsumerListResponse, RuntimeError>({
        path: `/v1/shards/list`,
        method: "POST",
        body: body,
     ...
     * @response `default` `RuntimeError` An unexpected error response.
     */
    shardStat: (body: ConsumerStatRequest, params: RequestParams = {}) =>
      this.request<ConsumerStatResponse, RuntimeError>({
        path: `/v1/shards/stat`,
        method: "POST",
        body: body,
        type: ContentType.Json,
