...
export class Api<SecurityDataType extends unknown> extends HttpClient<SecurityDataType> {
  v1 = {
     ...
     */
    journalList: (body: ProtocolListRequest, params: RequestParams = {}) =>
      this.request<ProtocolListResponse, RuntimeError>({
     ...
     * @response `default` `RuntimeError` An unexpected error response.
     */
    journalRead: (body: ProtocolReadRequest, params: RequestParams = {}) =>
      this.request<{ result?: ProtocolReadResponse; error?: RuntimeStreamError }, RuntimeError>({
